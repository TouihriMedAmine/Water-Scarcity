...
DATA_DIR = os.path.join(os.path.dirname(__file__), "../visualization_outputUp_2019_2024/Rainf")
MODEL_PATH = os.path.join(os.path.dirname(__file__), "modele_unet_Rainf.h5")
IMG_MIN = 0.0
IMG_MAX = 1.0
...
def extract_date_from_filename(filename):
    """Extrait la date du nom de fichier (ex: Rainf_20190101.png)"""
...
def find_jmoins1_image_path(date_cible):
    ...
    filename = f"Rainf_{date_jmoins1.strftime('%Y%m%d')}.png"
...
def predict():
    ...
    physical_prediction = MAX_PHYSICAL_VALUE - pred_norm * MAX_PHYSICAL_VALUE
