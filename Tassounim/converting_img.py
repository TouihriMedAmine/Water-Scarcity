...
attributes = {
    ...
    "Qs": {"title": "Surface Runoff (Non-infiltrating)", "vmin": 0, "vmax": 0.0005, "cmap": "Blues"},
    
    # Subsurface Runoff (Baseflow)
    "Qsb": {"title": "Subsurface Runoff (Baseflow)", "vmin": 0, "vmax": 0.0002, "cmap": "GnBu"},
    
    # Total Evapotranspiration
    "Evap": {"title": "Total Evapotranspiration", "vmin": 0, "vmax": 0.0008, "cmap": "YlGnBu"},
}
